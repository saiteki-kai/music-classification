...
Starting from approaches based on handcrafted features, the project moved on to approaches based on the audio's MFCs using CNNs. 
The Transfer Learning method was then tried to try to get better performances.

We achieved the best results using ResNet50 with \textbf{0.5012} of accuracy on the test set.\\
