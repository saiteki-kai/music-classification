...
\begin{table}[ht]
  ...
  \caption{results of the fc2 cut level of VGG16 with different classifier and different values of pca.}
  \label{tab:my-table}
\end{table}
...
\caption{hyperparameters result for the VGG16 FC2 with different values of pca.}
\label{tab:my-table}
\end{table}
...
\caption{hyperparameters result for different cut level of VGG16 with PCA=0.90.}
\label{tab:my-table}
\end{table}
...
\caption{hyperparameters result for different cut of ResNet50 with PCA=0.90.}
\label{tab:my-table}
\end{table}
...
\begin{table}[ht]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{|c|c|c|c|}
      ...
      resnet50\_best & 57.9110 ms     & 25.4181 ms      & 3.2712 ms \\ \hline
    \end{tabular}%
  }
